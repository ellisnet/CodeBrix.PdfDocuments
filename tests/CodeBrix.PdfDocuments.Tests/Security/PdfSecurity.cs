...
namespace CodeBrix.PdfDocuments.Tests.Security; //Was previously: namespace PdfSharpCore.Test.Security;
...
public class PdfSecurity
{
    ...
    public void CreateAndReadPasswordProtectedPdf(PdfDocumentSecurityLevel securityLevel, string password)
    {
        ...
        loadDocument.Info.Producer.Should().Contain(ProductVersionInfo.Title);
    }
